class Main {
  ...
  void init(){
    ...
    int tax[]={56,43,74,23,6,4,43};
    print(totalWithTax(tax));

    // 3: Integer Present ?
    int []a ={1,3,4,2,5,6,4,3}
    print(isPresent(a,5));
    print(isPresent(a,9));
    // 4: Lotto
    int lotto[] = {8,9,18,25,69,19};
  ...
  To test the function, create an array representing your lotto number picks and another array representing the lotto numbers drawn
    */ 
   int checkLotto(int[] pics, int[]drawn){
      int x= 0;
      for()
   }
