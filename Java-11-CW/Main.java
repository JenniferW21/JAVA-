class Main {
  ...
  void init(){
    ...
    System.out.println(createUsername("John","Doe","123456789"));
    
  }
  /*
    Problem 1:
    Write a function getUsername() that accepts an email and returns the user name.   
    Example: joexyz@gmail.com ==> joexyz
  */  
