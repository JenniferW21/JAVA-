...
class Main {
 ...
 public static void main(String[] args)throws IOException{
  ...
  void init() {
    ...
    sql = " Insert Into cr101(course, section, period, teacher1, room,  studentid) values ('MCLUB1', 3, 1, 'WHOKNOWS', 'ROOFTOP', 'STUDENT2') " ;

    db.runSQL(sql);
    
    
    // 2: For student with ID “STUDENT4”, add course “CN100” with a section 1, teacher1 as  “JOSEPH”, period 2 and room 108.
    sql = " Insert Into cr101(course, section, period, teacher1, room,  studentid) values ('CN100', 1, 2, 'JOSEPH', 108, 'STUDENT4') " ;
