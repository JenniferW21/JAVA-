class Main {
  ...
  void init(){    
    ...
    // more accurate approximation of Pi
...
/* 1:   Write a function approxPI() that accepts a value for # of terms and approximates the value of PI. (See the general forumula described in the file PI.png)
