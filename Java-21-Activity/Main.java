...
*/
  void allowance1(){
    ...
    int pennyPlan= 1;
    while(pennyPlan < 500){
      print("Day" + x + ":" + pennyPlan);
      pennyPlan *= 2;
      x++;
    }
    print("Penny Plan exceeds $5 in" +x+ "days. Value is: " + pennyPlan +"pennies");
  }
...
*/
  void allowance2(){
    ...
    print("\nPlan 2 exceeds Plan 1 on Day: " + x);
  }
...
*/   
  void addTwoNumbers(){
    ...
    int ans =-50; //any never that will not affect the data or be the correct answer
    while(n1 + n2 ==ans){
      ans=Input.ReadInt()
    }
}
