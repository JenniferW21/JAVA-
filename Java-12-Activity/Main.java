class Main {
  ...
  void init(){
    System.out.println(creditCardType(45));
...
/*
    ...
    6011 or 65 - Discover
    */
    String creditCardType(String credNum){
      if(credNum.substring(0,1).equals("4"))
        return "Visa";
      else if(credNum.substring(0,2).equals("34")||credNum.substring(0,2).equals("37"))
        return "American Express";
      else if (credNum.substring(0,2).equals("36"))
        return "Diner's Club";
      else if(credNum.substring(0,2).equals("51")||credNum.substring(0,2).equals("55"))
        return "Mastercard";
      else if(credNum.substring(0,4).equals("6011")||credNum.substring(0,2).equals("65"))
        return "Discover";
      else 
    ...
    */
    String pigLatin(String s){
      return substring(1) + substring(0,2) + "ay"; 
    }
